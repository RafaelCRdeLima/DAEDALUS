...
export const fr: Catalog = {
  ...
  v_tubo: () => 'Tube 3D',
  v_tubo_dica: () => 'Faites glisser pour tourner. La couture n’apparaît pas comme une cicatrice car le plongement est hélicoïdal : toute liaison latérale a la même longueur, y compris la sienne. La couture est une discontinuité de réseau — contact α–α là où le reste a α–β — non de forme.',
  v_tubo_fechado: () => 'Le tube étant fermé longitudinalement, les liaisons qui joignent les deux extrémités traversent le cylindre sur le dessin : le graphe est périodique, le cylindre ne peut pas l’être.',
  v_tubo_metrico: () => 'échelle métrique',
  v_tubo_escala: (p) => `Axe comprimé ×${p['fator']} : le long du tube, les distances NE sont PAS à la même échelle que les latérales. Un microtubule est bien trop long pour tenir à l’échelle vraie — à ×1 l’échelle est honnête et le tube devient un cheveu.`,
