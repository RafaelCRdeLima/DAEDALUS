...
export const fr: Catalog = {
  ...
  sec_trajetorias: () => 'trajectoires (phase 2)',
  tr_desligado: () => 'désactivé',
  tr_n: () => 'trajectoires',
  tr_gamma: () => 'γ déphasage',
  tr_stride: () => 'échantillonnage de ρ',
  tr_amostras: () => 'échantillons',
  tr_rho: () => 'accumuler ρ',
  tr_psi: () => 'archiver ψ',
  tr_por_thread: () => 'par thread',
  tr_por_celula: () => 'par cellule',
  tr_plano: () => 'sur un plan de 100',
  tr_sem_modo_curto: () => 'sans mode',
  tr_rho_quando: () => 'ρ est sommé pendant l’exécution et chaque ψ est jeté. À choisir pour un balayage large, les observables étant déjà fixés.',
  tr_psi_quando: () => 'les ψ sont écrits et ρ est assemblé à l’analyse. À choisir tant que la définition de l’observable peut encore changer — ce qui est déjà arrivé une fois dans ce projet.',
  tr_sem_modo: () => 'Choisissez l’un des deux. Il n’y a pas de défaut : ils résolvent des problèmes différents, et qui a choisi d’accumuler ρ puis changé la définition de l’observable n’a plus les ψ pour recalculer.',
