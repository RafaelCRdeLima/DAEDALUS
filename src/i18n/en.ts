...
export const en: Catalog = {
  ...
  sec_trajetorias: () => 'trajectories (phase 2)',
  tr_desligado: () => 'off',
  tr_n: () => 'trajectories',
  tr_gamma: () => 'γ dephasing',
  tr_stride: () => 'ρ sampling',
  tr_amostras: () => 'samples',
  tr_rho: () => 'accumulate ρ',
  tr_psi: () => 'archive ψ',
  tr_por_thread: () => 'per thread',
  tr_por_celula: () => 'per cell',
  tr_plano: () => 'over a 100-cell plane',
  tr_sem_modo_curto: () => 'no mode',
  tr_rho_quando: () => 'ρ is summed during the run and each ψ discarded. Choose this for a wide sweep, with the observables already settled.',
  tr_psi_quando: () => 'the ψ are written and ρ is assembled at analysis time. Choose this while the definition of the observable may still change — which in this project has already happened once.',
  tr_sem_modo: () => 'Pick one of the two. There is no default: they solve different problems, and whoever picked accumulate ρ and then changed the definition of the observable has no ψ left to recompute from.',
